...
sleep 5 && psql -U postgres -c "ALTER SYSTEM SET listen_addresses TO '*'"
...
psql -U postgres -c "ALTER SYSTEM SET synchronous_commit TO 'remote_apply'"
...
psql -U postgres -c "ALTER SYSTEM SET wal_log_hints TO 'on'"
psql -U postgres -c "ALTER SYSTEM SET max_wal_senders TO '10'"
psql -U postgres -c "ALTER SYSTEM SET wal_keep_segments TO '4'"
